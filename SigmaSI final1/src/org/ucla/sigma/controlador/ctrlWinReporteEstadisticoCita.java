 ...
 * 
 */
public class ctrlWinReporteEstadisticoCita extends GenericForwardComposer {

	// ----------------------------------------------------------------------------------------------------

	private Window winReporteEstadisticoCita;
	...
	private String rutaJrxml = "/sigma/vistas/reportes/reportesJR/estadisticoReferencia/estadisticoCita.jrxml";
	...
	public void onClick$btnExportar() {
		...
		parametrosJasper.put("titulo", "Frecuencia de Citas Asignadas por Servicios");
		...
		parametros.put("titulo", "Frecuencia de Citas Asignadas por Servicios");
