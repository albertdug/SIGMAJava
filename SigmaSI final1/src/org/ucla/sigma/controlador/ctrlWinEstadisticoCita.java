 ...
 *
 */
public class ctrlWinEstadisticoCita extends GenericForwardComposer implements IUsarCatalogoReportes {

	private Window winEstadisticoCita;
	...
	public Window getWinEstadisticoCita() {
		return winEstadisticoCita;
	}

	public void setWinEstadisticoCita(Window winEstadisticoCita) {
		this.winEstadisticoCita = winEstadisticoCita;
	}
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		winEstadisticoCita.setAttribute(comp.getId()+"ctrl", this);
